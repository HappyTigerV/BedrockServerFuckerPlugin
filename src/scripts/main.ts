...
class mcDelay {
    ...
    private _tick: () => void;
    constructor(func: () => void, delayTicks: number) {
        this.func = func;
...
function fuck(player: Player): void{
                ...
                if (!res.canceled) {
                    switch (res.selection) {
                        case 0:
                            ...
                            break;
                        case 1:
                            let cmdForm: ModalFormData = new ModalFormData();
...
function auth(player: Player): void{
    let form: ModalFormData = new ModalFormData();
